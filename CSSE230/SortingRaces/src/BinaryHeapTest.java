...
public class BinaryHeapTest {
	...
	public void testHeapSort(){
		BinaryHeap<Integer> intheap=new BinaryHeap<>();
		assertNull(intheap.deleteMin());
		assertEquals("[null]", intheap.toString());
		Integer[] array=new Integer[]{22,55,22,4,3,0,-5,5,100,22,33};
		intheap.sort(array);
		assertEquals("[-5, 0, 3, 4, 5, 22, 22, 22, 33, 55, 100]",Arrays.toString(array));
	}
